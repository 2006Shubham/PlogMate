...
public class SocialShelfFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        adapter = new EventAdapter(getContext(), eventList,new SocialShelfFragment());
    ...
    private void fetchPloggingEvents() {
        String url = "http://192.168.150.81:7070/event_api/get_events.php?event_type=SS";
